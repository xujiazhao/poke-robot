...
技术再强，如果用户不知道你在做什么、为什么做，那就只是一群工程师的自嗨。Poke 需要一套清晰的对外表达体系——不是广告词，而是让每一个接触到 Poke 的人，在 3 秒内理解"这家公司跟别人有什么不一样"。

### Poke 主张：是家人，而非机器

我反复思考后，觉得 Poke 最有力的一句话应该是——**「是家人，而非机器」**（英文：Family, not a machine.）。

为什么是这句？因为它直接回答了用户心里最大的疑问："你们的机器人跟那些翻跟头的有什么区别？"答案不是参数、不是技术路线，而是一个承诺：**我们做的不是一台冷冰冰的设备，而是一个可以融入你家庭的存在。**

这句话同时也暗含了 Poke 的野心——不做表演机器人，做真正能走进千家万户的产品。它足够简短、足够情感化，可以用在任何需要一句话介绍 Poke 的场景。
...
如果核心主张是"标题"，那 Brand Manifesto 就是"第二句话"——用一句话把 Poke 的态度说透：

> 「我们不制造表演机器，我们创造*属于你的*家庭机器人。」
> "We don't build performing machines. We build home robots that *belong to you*."

这句话的力量在于"表演"和"属于"的对比。市面上的人形机器人几乎都还停留在"表演"阶段——翻跟头、跳舞、做俯卧撑。Poke 要做的事情恰好相反：不表演，而是真正属于一个家庭。一句话就把 Poke 和所有竞品拉开了距离。

核心主张 + 三条产品哲学 + Brand Manifesto，构成了 Poke 对外表达的完整骨架。无论是官网、PR 物料、招聘 JD 还是投资人 deck，所有文案都应该从这套体系里生长出来，而不是每次重新发明。
...
在所有设计工作里，我选择先从 Logo 入手。原因很简单：Logo 是品牌最小的识别单元，也是用户接触 Poke 的第一个视觉触点。团队之前有一版 Logo，但在小尺寸场景下辨识度不够，风格上也没有传递出"家庭感"和"温度"。一个好的 Logo 应该做到：远看认得出，近看有细节，缩到 16px 还能用。

所以我集中时间重新构思了 Logo 体系。公司名确认为 **Poke Robotics** 后，我设计了三个版本来覆盖不同场景：
...
3. **反白适配**：Logo 需要同时适配深色背景（如首屏大图上的白色版本）和浅色背景（如滚动后导航栏上的品牌红版本）。
4. **多版本策略**：不同场景用不同版本，而不是把一个 Logo 硬塞到所有地方。
...
Logo 体系确定之后，下一步就是官网。官网不是一个"好看的页面"，它是 Poke 对外表达体系的第一个完整载体——上面提到的核心主张、产品哲学、Brand Manifesto、Logo，都需要在这里落地成一个用户可以真正看到、感受到的东西。

设计理念上，我遵循了几个原则：

1. **高级但不冷漠**：配色以中性色为主（白底、深灰文字、浅灰卡片），品牌红 `#c8102e` 克制使用——只在最关键的地方点亮，而不是满屏都是。整体感觉应该像一个有品位的产品公司，而不是一个炫技的科技公司。
2. **内容驱动，不是装饰驱动**：页面上的每一块内容都有明确的功能——首屏建立第一印象，价值观区域传递产品哲学，Manifesto 区域强化品牌态度，招聘区域吸引人才。没有多余的装饰性元素。
3. **中英双语原生支持**：不是翻译，而是两套各自通顺的文案。中文用户看到"是家人，而非机器"，英文用户看到"Family, not a machine."——都是母语级的表达。
4. **移动端不是桌面端的缩小版**：移动端有独立的背景图、独立的 Logo 版本、独立的布局逻辑。首屏内容贴底、标题加大、文字居中——让手机用户也能有完整的品牌体验。
5. **轻量、快速、不依赖框架**：纯 HTML + CSS + JS，不引入任何前端框架。页面加载快，维护简单，创始人自己也能改文案。
...
### 已完成 ✅
- [x] 品牌表达体系建立（核心主张 + 产品哲学 + Manifesto）
